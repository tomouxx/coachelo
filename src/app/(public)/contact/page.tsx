  ...
  return (
    <>
      <section className="container-editorial pt-20 pb-12 text-center">
        <p className="eyebrow">{pg("contact_page_eyebrow", "Contact")}</p>
        <h1 className="section-title mt-3">{pg("contact_page_title", "Réservons ta première séance")}</h1>
        <p className="mt-5 max-w-xl mx-auto text-brand-taupe">
          {pg("contact_page_description", "Trois chemins possibles : réserver un créneau, m'envoyer un message, ou planifier un appel découverte offert.")}
        </p>
      </section>
